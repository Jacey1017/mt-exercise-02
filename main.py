...
# add a new argument for logging
parser.add_argument('--log_file', type=str, default=None,
                    help='path to save validation perplexity log')
...
if args.log_file:
    with open(args.log_file, "w") as f:
        f.write("epoch\ttrain_ppl\tvalid_ppl\n")
    ...
    for epoch in range(1, args.epochs+1):
        ...
        if args.log_file:
            with open(args.log_file, "a") as f:
                f.write(f"{epoch}\t{train_ppl:.2f}\t{valid_ppl:.2f}\n")
